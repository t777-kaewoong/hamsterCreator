...
// 아래쪽 절반(M0-3~M0-4)은 기본 UI 컴포넌트 8종과 저장소 동작을 한 페이지에 모아 보여줍니다.
// 실제 편집기 화면이 아니라 "부품이 PRD §9.7 수치대로 만들어졌는지" 확인하는 용도라,
// 주소 뒤에 ?catalog 를 붙였을 때만(App.tsx 참고) 보이는 개발자용 화면입니다.
