...
## In Progress
- [ ] M1-5 텍스트·마커 도구(FR-4) + 인스펙터(§9.13) + 시작 화면(§9.8)

## Next Steps
1. FR-4 텍스트 라벨(T)·출발/도착 마커(M) 도구 + 선 위 흰 글씨 모드
2. §9.18 6단계 인스펙터 (§9.13) — 선택 항목 속성 편집
3. §9.18 7단계 시작 화면 (§9.8) — 프리셋·파일 열기·초안 복구
4. M1.5 자유곡선 트랙 (FR-10)
5. M2 단일장 PDF (SP-7 한글 폰트 임베드 확인 포함)
